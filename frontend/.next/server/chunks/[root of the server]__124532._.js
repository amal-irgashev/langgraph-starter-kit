...
"[project]/app/api/threads/[threadId]/history/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        const apiUrl = ("TURBOPACK compile-time value", "http://localhost:8123");
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        }
        // Get thread history from LangGraph
        const response = await fetch(`${apiUrl}/threads/${params.threadId}/messages`, {
            method: 'GET',
            headers: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__124532._.js.map