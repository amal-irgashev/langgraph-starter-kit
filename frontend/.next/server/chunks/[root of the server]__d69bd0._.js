...
"[project]/app/api/threads/[threadId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8000")}/threads/${params.threadId}/summary`, {
            method: 'GET',
            headers: {
...
async function DELETE(request, { params }) {
    try {
        const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8000")}/threads/${params.threadId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d69bd0._.js.map